 ...
 * @author ASUS
 */
public class data_masuk_uang extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();

    /**
     * Creates new form data_masuk_uang
     */
    public data_masuk_uang() throws SQLException 
    {
        initComponents();
        tanggal();
        autoNumber();
    ...
    private void txt_jumlahKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_jumlahKeyReleased
        ...
        int uang;
        uang = Integer.valueOf(txt_jumlah.getText())* 38500;
        txt_total.setText(String.valueOf(uang));
    }//GEN-LAST:event_txt_jumlahKeyReleased

    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        String sql = "insert into tb_zkt values (?,?,?,?,?,?,?)";
        String sql2 = "SELECT nama FROM tb_zkt ORDER BY nama DESC LIMIT 1";
        ...
        try{
            ...
            uang = Integer.parseInt(txt_jumlah.getText())* 38500;
            stat.setString(6,String.valueOf(uang));
        ...
        txt_info.setText("Zakat Atas Nama : "+txt_nama.getText()+
            ...
            "\nDengan Total : "+txt_total.getText()+ " Rupiah");
    }//GEN-LAST:event_btn_simpanActionPerformed

    private void btn_cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cetakActionPerformed
        try{
            InputStream file = getClass().getResourceAsStream("/ireport/bayar_uang1.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(data_masuk_uang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new data_masuk_uang().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(data_masuk_uang.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
